...
import 'exhaustion_page_model.dart';
export 'exhaustion_page_model.dart';

class ExhaustionPageWidget extends StatefulWidget {
  const ExhaustionPageWidget({super.key});

  static String routeName = 'ExhaustionPage';
  static String routePath = '/exhaustionPage';

  @override
  State<ExhaustionPageWidget> createState() => _ExhaustionPageWidgetState();
}

class _ExhaustionPageWidgetState extends State<ExhaustionPageWidget> {
  late ExhaustionPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExhaustionPageModel());
  }
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<DailyScoresRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<DailyScoresRecord> exhaustionPageDailyScoresRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final exhaustionPageDailyScoresRecord =
            exhaustionPageDailyScoresRecordList.isNotEmpty
                ? exhaustionPageDailyScoresRecordList.first
                : null;
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          valueOrDefault<String>(
                                            dateTimeFormat(
                                                "dd.MM.yyyy, HH:mm",
                                                exhaustionPageDailyScoresRecord
                                                    ?.calculatedAt),
                                            'n/a',
                                          ),
                                          style: FlutterFlowTheme.of(context)
                          ...
                          stream: queryMarkerDailyValuesRecord(
                            queryBuilder: (markerDailyValuesRecord) =>
                                markerDailyValuesRecord
                                    ...
                                    .where(
                                      'week_key',
                                      isEqualTo: exhaustionPageDailyScoresRecord
                                          ?.weekKey,
                                    )
                                    .orderBy('day_index'),
                            limit: 7,
                                          ...
                                          Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Stack(
                                                  children: [
                                                    if (exhaustionPageDailyScoresRecord
                                                            ?.scoreAvailable ==
                                                        true)
                                                      Padding(
                                                        padding:
                          ...
                          child: Text(
                            valueOrDefault<String>(
                              functions.getMarkerStatusInterpretation(
                                  functions.getMarkerStatusLabel(
                                      'exhaustion',
                                      listViewDailyInputsRecord?.exhaustion,
                                      exhaustionPageDailyScoresRecord
                                          ?.exhaustionBaseline14d)),
                              'Interpretation',
                            ),
                              ...
                              children: [
                                Align(
                                  ...
                                  child: InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      _model.isExhaustionInfoExpanded =
                                          !_model.isExhaustionInfoExpanded;
                                      safeSetState(() {});
                                    },
                                    child: Container(
                                ...
                                if (_model.isExhaustionInfoExpanded == true)
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        7.0, 15.0, 7.0, 0.0),
                                    child: Text(
